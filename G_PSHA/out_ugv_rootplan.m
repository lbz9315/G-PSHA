...
%%
function [p1,p2]=out_ugv_rootplan(center,k1) 
citys=[0,0,0;0,0,0;center];
p1=[];
...
%% VIII. 把蚁群排序结果存到P中
for ii=1:n
    p1=[p1;citys(shortest_Route(ii),1),citys(shortest_Route(ii),2),citys(shortest_Route(ii),3)];
end
p3=shortest_Route(:,2:k1+1);
